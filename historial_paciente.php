<?php
    ...
    // La consulta que ha de paginarse
        $query = 'SELECT INFORMES.OIDINFORME, INFORMES.FECHACONSULTA,INFORMES.MOTIVOCONSTULTA, INFORMES.TRATAMIENTO, INFORMES.OIDHISTORIAL, '
        . 'HISTORIALES.OIDHISTORIAL, HISTORIALES.IDPACIENTE '
        .' FROM INFORMES, HISTORIALES '
        .' WHERE '.' INFORMES.OIDHISTORIAL = (SELECT HISTORIALES.OIDHISTORIAL FROM HISTORIALES WHERE IDPACIENTE='. $id .')';
    } else {
